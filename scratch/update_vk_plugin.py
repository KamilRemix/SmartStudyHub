...
plugin_path = r'android\app\src\main\java\com\smartstudyhub\mobile\VkAuthPlugin.java'

java_content = """package com.smartstudyhub.mobile;
...
import com.vk.id.auth.VKIDAuthFail;
...
print("Updated VkAuthPlugin.java")
